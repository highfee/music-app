...
const Volume = ({ min, max, onChange, value, volume, setVolume }) => {
  const muted = false;
  return (
    <div className="hidden md:block flex-grow-[1] relative">
      <div className="flex items-center gap-[10px] absolut right-0">
        {!volume > 0 ? (
          ...
          >
            <path
              d="M13.5 12.5625C13.38 12.5625 13.2675 12.525 13.1625 12.45C12.915 12.2625 12.8625 11.91 13.05 11.6625C14.2275 10.095 14.2275 7.90496 13.05 6.33746C12.8625 6.08996 12.915 5.73746 13.1625 5.54996C13.41 5.36246 13.7625 5.41496 13.95 5.66246C15.42 7.62746 15.42 10.3725 13.95 12.3375C13.8375 12.4875 13.6725 12.5625 13.5 12.5625Z"
              fill="#EFEEE0"
            />
            <path
              d="M14.8725 14.4375C14.7525 14.4375 14.64 14.4 14.535 14.325C14.2875 14.1375 14.235 13.785 14.4225 13.5375C16.425 10.8675 16.425 7.13246 14.4225 4.46246C14.235 4.21496 14.2875 3.86246 14.535 3.67496C14.7825 3.48746 15.135 3.53996 15.3225 3.78746C17.625 6.85496 17.625 11.145 15.3225 14.2125C15.2175 14.3625 15.045 14.4375 14.8725 14.4375Z"
              fill="#EFEEE0"
            />
            <path
        ...
        <input
          ...
          value={value}
          onChange={onChange}
          className="md:block w-12 md:w-30 2xl:w-[100px] h-1  volume"
        />
      </div>
    </div>
  );
