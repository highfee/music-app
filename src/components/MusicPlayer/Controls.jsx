...
const Controls = ({
  ...
  return (
    <div className="flex flex-grow-[1] items-center gap-1 md:gap-9">
      <div className="hidden md:block">
        <div
          className={`cursor-pointer ${
            shuffle &&
            "h-[25px] w-[25px] grid place-items-center bg-gray-400 rounded-full "
          }`}
          onClick={() => {
            setShuffle(!shuffle);
          }}
      ...
      <div onClick={handlePrevSong} className="cursor-pointer hidden md:block">
        <svg
          width="16"
          height="17"
          viewBox="0 0 16 17"
        ...
        {!isPlaying ? (
          <div>
            <svg
              ...
              xmlns="http://www.w3.org/2000/svg"
            >
              <g filter="url(#filter0_d_7374_172)">
                <rect
                  x="18"
                  y="18"
                  width="25"
              ...
              <defs>
                ...
                >
                  ...
                  <feBlend
                    ...
                    result="effect1_dropShadow_7374_172"
                  />
                  <feBlend
                    mode="normal"
                    in="SourceGraphic"
                    in2="effect1_dropShadow_7374_172"
                    result="shape"
                  />
                </filter>
              </defs>
          ...
          <div>
            <svg
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 512 512"
              className="text-white w-8 my-4 mx-4"
            >
      ...
      <div onClick={handleNextSong} className="cursor-pointer">
        <svg
          width="16"
          height="17"
          viewBox="0 0 16 17"
