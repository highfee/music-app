...
const Sidebar = () => {
  return (
    <div className="animate-slideleft sticky top-0 hidden md:block">
      <div className="flex flex-col gap-10 items-center">
        <Link to="/">
          <img src={logo} alt="" />
        </Link>
        <div className="bg-[#1A1E1F] rounded-[32px] h-[230px] w-[52px] flex flex-col items-center justify-evenly cursor-pointer transition-all duration-500">
          <Link to="/">
            <svg
              width="40"
              height="42"
        ...
        <div className="bg-[#1A1E1F] rounded-[32px] h-[127px] w-[52px] flex flex-col items-center justify-evenly cursor-pointer relative top-[-20px]">
          <svg
            width="22"
            height="22"
            viewBox="0 0 22 22"
